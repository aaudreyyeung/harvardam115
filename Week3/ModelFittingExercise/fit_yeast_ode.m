...
%known (it is hard-coded in analytical_logistic and ode45_logistic as 
...
figure(1)
clf
plot(time,amount,'o','MarkerSize',14,'LineWidth',2);
hold on;
plot(time,yfit,'LineWidth',2)
xlabel('hours');
ylabel('Yeast amount');
...
figure(2)
clf
plot(time,R,'-o','MarkerSize',14,'LineWidth',2);xlabel('hours');ylabel('Residual');
set(gca,'FontSize',14,'LineWidth',2)
pause
